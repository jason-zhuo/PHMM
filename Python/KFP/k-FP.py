...
rootdir = r"/Volumes/MacHD/zzltest/USENIX2016/home200new/"
alexa_monitored_data = rootdir + r"KFP200new-L300size/"
# rootdir = r"/Users/zhuozhongliu/Desktop/KPFretest/Alexa74/"
# alexa_monitored_data = rootdir + r"nosize/"
...
unmonitored_data = rootdir + r"KFPopen2000-L300/"
dic_of_feature_data = rootdir + r"Features_ssh66"
...
def RF_closedworld(mon_type, path_to_dict = dic_of_feature_data):
    ...
    y_score=model.fit(tr_data, tr_label)
